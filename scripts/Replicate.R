{
  ...
  plot10 = ggplot( data=weatherData ) +
   ...
   #        strip.background = element_rect(fill="pink", color="pink"),
           ...
           axis.line.x.bottom = element_line(linewidth = 2, color = "blue"),
           axis.line.y.left = element_line(linewidth = 2, color = "blue"),
           axis.ticks.y.left = element_line(color="purple", linewidth=5),
           ...
           panel.grid.minor = element_line(linewidth=0.2, linetype=4, color="grey40"),
